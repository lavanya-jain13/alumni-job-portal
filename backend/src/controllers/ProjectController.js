...
exports.acceptProjectApplication = (req, res) =>
  updateProjectApplicationStatus(req, res, "accepted");

exports.rejectProjectApplication = (req, res) =>
  updateProjectApplicationStatus(req, res, "rejected");

exports.holdProjectApplication = (req, res) =>
  updateProjectApplicationStatus(req, res, "on_hold");
