...
exports.up = function(knex) {
  return knex.schema
    ...
    .createTable('companies', (table) => {
      table.uuid('alumni_id').primary().references('id').inTable('alumni_profiles').onDelete('CASCADE');
    ...
    .createTable('jobs', (table) => {
      table.uuid('id').primary().defaultTo(knex.raw('gen_random_uuid()'));
      table.uuid('company_id').notNullable().references('alumni_id').inTable('companies').onDelete('CASCADE');
      table.uuid('posted_by_alumni_id').notNullable().references('id').inTable('alumni_profiles').onDelete('SET NULL');
